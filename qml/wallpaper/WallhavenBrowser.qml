    ...
    Row {
      ...
      Repeater {
        ...
        Item {
          ...
          readonly property bool isHovered: _whColorMouse.containsMouse
          ...
          Canvas {
            ...
            property color bgCol: browser.colors ? browser.colors.surfaceContainer : Qt.rgba(0.1, 0.12, 0.18, 1.0)
          ...
          MouseArea {
            ...
            onClicked: {
              ...
              if (parent.isSelected) {
                browser.whService.selectedColor = -1
              } else {
                browser.whService.selectedColor = parent.filterValue
              }
              browser.whService.search(1)
            }
          }
